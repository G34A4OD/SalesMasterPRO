...
public class ClienteService {
    ...
    public ClienteDTO crearCliente(ClienteDTO clienteDTO) {
        ...
        // Recargar el cliente recién creado por email (ya que el ID pudo haber
        // cambiado)
    ...
    private void reordenarIdsClientes() {
        ...
        if (clientes.isEmpty()) {
            ...
            entityManager.createNativeQuery(
                    "SELECT setval('salesmaster.cliente_id_cliente_seq', 0, true)").getSingleResult();
            return;
        }
        ...
        try {
            ...
            entityManager.createNativeQuery(
                    "ALTER TABLE salesmaster.pedido DROP CONSTRAINT IF EXISTS pedido_id_cliente_fkey").executeUpdate();
